...
namespace DeveloperDemo_Card_Desktop.Utils {
    ...
    public class PrinterManager {
        ...
        private const int POST_RESET_DELAY = 5000;
        private const long RECONNECT_TIMEOUT = 60000;
        ...
        public async Task ReestablishConnection(bool resetPrinter) {
            ...
            await PerformAction("Reconnecting to printer...", (zebraCardPrinter, connection) => {
                ...
                CardConnectionReestablisher connectionReestablisher = connection.GetConnectionReestablisher(RECONNECT_TIMEOUT) as CardConnectionReestablisher;
